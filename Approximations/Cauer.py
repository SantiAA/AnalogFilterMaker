...
class Cauer(Approximation):
    ...
    def calculate(self, filter_in_use: Filter, n_max=20):
        ...
        if filter_in_use.get_type() is FilterTypes.LowPass:
            ...
            n, w = signal.ellipord(self.information[TemplateInfo.fp], self.information[TemplateInfo.fa],
            ...
            n, w = signal.ellipord(wp, wa, self.information[TemplateInfo.Ap], self.information[TemplateInfo.Aa],
                                   analog=True)
        ...
        z, p, k = signal.ellip(n, self.information[TemplateInfo.Ap], self.information[TemplateInfo.Aa], w, analog=True,
                               output='zpk', btype=type_)  # Desnormalizado
